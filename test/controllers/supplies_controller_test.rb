...
class SuppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post supplies_url, params: { supply: { code: @supply.code, content: @supply.content, name: @supply.name, price: @supply.price, product_id: @supply.product_id, set: @supply.set, stock_id: @supply.stock_id } }
    end
  ...
  test "should update supply" do
    patch supply_url(@supply), params: { supply: { code: @supply.code, content: @supply.content, name: @supply.name, price: @supply.price, product_id: @supply.product_id, set: @supply.set, stock_id: @supply.stock_id } }
